    ...
    return (
        <EssaysStyled>
            ...
            <Essay q='S4. What are Single Page Apps (SPAs)? How do they differ from traditional multi-page Web Sites?' >
                ...
                <p>MPAs are still more complex, with more levels, and are more difficult to develop than SPAs. However, they are better for SEO optimization and creating new and unique pages in a site. It also requires a smaller technology stack, and since it has been around longer, has more CMS solutions. SPAs may be easier for development, but it requires JavaScript to work and the download time might be slower because of its heavy framework that needs to be loaded. SPAs also seem less secure than MPAs.</p>
                <p>If you need to show a lot of different things or provide many different services and SEO is important, then you should probably use MPAs. If performance and management in limited web space is more of a preference, then SPAs would be better.</p>
            </Essay>
            <Essay q='S5. What is the difference between Web Designer, Front End Developer and Back End Developer?' >
                <ul>
                    <li><b>Web designer:</b> Web designers are responsible for the style and usability of a website. They work on the look at the feel of the website. They design what the website is going to look like and how users will interact with it. Some kinds of web designers include graphic designers, UX designers, UI designers, SEO specialists, content strategists and more. Web designers often use graphic editing software such as Adobe Photoshop, Core Draw, Sketch, Figma, Invision, etc. </li>
                    <li><b>Front-end Web Developer:</b> Front-end web developers are programmers who work on the client-side of the website and implement the designs made by the web designers. They work with the web designers, take their designs and ideas, and make them in to a fully-functioning website. While web designers are focused on the design of the website, front-end developers are focused on its function. They are making sure that the layout is right, the buttons and links do what they’re supposed to and that everything is working properly. Front-end developers use HTML, CSS, and Javascript as well as other languages, frameworks, and libraries. </li>
                    <li><b>Back-end Web Developer:</b> Back-end web developers work on the part of the website that isn’t seen or used by the user. They are focused on the server side of the website. When a website goes from static to dynamic, information is being transferred between the user and the server through the website. Back-end developers make sure that the data is being managed properly and the user is receiving the proper response. They work on the website’s data management, API function, accessibility and security. They work closely with front-end developers to make sure both sides are functioning together properly. Though back-end developers also use JavaScript, they also need to know other programming languages like Python, Ruby, PHP, and Java as well as frameworks and libraries. </li>
                    <li><b>Full-stack developer:</b> A full-stack developer is someone who knows how to develop both the front-end and back-end. They are strong enough in both to make a complete website, but are not specialized in either side, so they are good for smaller businesses or startups. </li>
                </ul>
            </Essay>
